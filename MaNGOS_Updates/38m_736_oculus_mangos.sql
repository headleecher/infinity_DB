...
-- Fixes for zonig in and out of oculus
-- Nexus Portal
...
-- FallenAngelX
ALTER TABLE db_version_Infinity_Update CHANGE COLUMN r37 r38 bit;
REPLACE INTO `db_version_Infinity_Update` (`version`) VALUES ('r38');

UPDATE db_version SET `cache_id`= 'r38';
UPDATE db_version SET `version`= 'YTDB579_Infinity_Update_r38';